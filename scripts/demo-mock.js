...
(function () {
  ...
  // a small, dismissible "demo" ribbon
  function banner() {
    ...
    d.innerHTML = 'DEMO · simulated, no hardware — <a href="https://github.com/mana-am/claude-f-me" style="color:#ff8fb8;text-decoration:underline;">install the plugin →</a>';
